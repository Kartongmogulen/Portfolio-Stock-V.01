        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector4[] sourceUVs0_vector4 = cachedMeshInfoVertexData[materialIndex].uvs0; // Original array
                    Vector2[] sourceUVs0 = sourceUVs0_vector4.Select(v => new Vector2(v.x, v.y)).ToArray(); // Konvertering

                    Vector4[] destinationUVs0_vector4 = textInfo.meshInfo[materialIndex].uvs0;
                    Vector2[] destinationUVs0 = destinationUVs0_vector4.Select(v => new Vector2(v.x, v.y)).ToArray(); // Konvertering;
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    Vector4[] textInfo_vector4 = textInfo.meshInfo[i].uvs0;

                    textInfo.meshInfo[i].mesh.uv = textInfo_vector4.Select(v => new Vector2(v.x, v.y)).ToArray(); // Konvertering;
