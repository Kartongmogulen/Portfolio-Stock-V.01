...
public class dividendRecieved : MonoBehaviour
{
    ...
    void Awake()
    {
		...
		for (int i = 0; i < StockMarketManager.StockUtiList.Count; i++)
		{
			...
			utiCompanyDivPayout.Add(StockMarketManager.StockUtiList[i].dividendPerShare);
		...
		for (int i = 0; i < StockMarketManager.StockTechList.Count; i++)
		{
			...
			techCompanyDivPayout.Add(StockMarketManager.StockTechList[i].dividendPerShare);
		...
		for (int i = 0; i < StockMarketManager_1850.StockPrefabListMines.Count; i++)
		{
			...
			minesCompanyDivPayout.Add(StockMarketManager_1850.StockPrefabListMines[i].GetComponent<stock>().dividendPerShare);
		...
		for(int i = 0; i < StockMarketManager_1850.StockPrefabListRailroad.Count; i++)
		{
			...
			railroadCompanyDivPayout.Add(StockMarketManager_1850.StockPrefabListMines[i].GetComponent<stock>().dividendPerShare);
		...
		for (int i = 0; i < StockMarketManager_1850.StockPrefabListIndustri.Count; i++)
		{
			...
			{
				industriCompanyDivPayout.Add(StockMarketManager_1850.StockPrefabListIndustri[i].GetComponent<stock>().dividendPerShare);
			}
	...
	public void recievedDividends()
    {
		...
		for (int i = 0; i < StockMarketManager.StockUtiList.Count; i++) {
			utiCompanyDivPayout[i] = StockMarketManager.StockUtiList[i].GetComponent<stock>().dividendPerShare;
		...
		for (int i = 0; i < StockMarketManager.StockTechList.Count; i++)
		{
			techCompanyDivPayout[i] = StockMarketManager.StockTechList[i].GetComponent<stock>().dividendPerShare;
		...
		for (int i = 0; i < StockMarketManager_1850.StockPrefabListMines.Count; i++)
		{
			...
			minesCompanyDivPayout[i] = StockMarketManager_1850.StockPrefabListMines[i].GetComponent<stock>().dividendPerShare;
		...
		for (int i = 0; i < StockMarketManager_1850.StockPrefabListRailroad.Count; i++)
		{
			...
			railroadCompanyDivPayout[i] = StockMarketManager_1850.StockPrefabListRailroad[i].GetComponent<stock>().dividendPerShare;
		...
		for (int i = 0; i < StockMarketManager_1850.StockPrefabListIndustri.Count; i++)
		{
			...
			{
				industriCompanyDivPayout[i] = StockMarketManager_1850.StockPrefabListIndustri[i].GetComponent<stock>().dividendPerShare;
				industriCompanySharesOwned[i] = PortfolioStock.industriCompanySharesOwned[i];
				industriCompanyDivRecieved[i] = industriCompanyDivPayout[i] * industriCompanySharesOwned[i];
