	...
	public void onChangeInput_1850()
	{
		if (inputOrderAmount_1850.text != "")
		{
			...
			if (activeSector == 0)
			{
				...
				stockPrice = StockMarketManager_1850.StockPrefabListMines[cityManager.activeCity].GetComponent<stock>().StockPrice[StockMarketManager_1850.StockPrefabListMines[0].GetComponent<stock>().StockPrice.Count-1];
			}

			if (activeSector == 1)
			{
				//activeCompany = StockMarketManager_1850.StockPrefabListMines[0];
				stockPrice = StockMarketManager_1850.StockPrefabListRailroad[cityManager.activeCity].GetComponent<stock>().StockPrice[StockMarketManager_1850.StockPrefabListRailroad[0].GetComponent<stock>().StockPrice.Count - 1];
			}

			if (activeSector == 2 && StockMarketManager_1850.StockPrefabListIndustri[cityManager.activeCity].GetComponent<priceStock>() != null)
			{
				//activeCompany = StockMarketManager_1850.StockPrefabListMines[0];
				stockPrice = StockMarketManager_1850.StockPrefabListIndustri[cityManager.activeCity].GetComponent<priceStock>().StockPrice[StockMarketManager_1850.StockPrefabListIndustri[cityManager.activeCity].GetComponent<priceStock>().StockPrice.Count - 1];
			}
			else if (activeSector == 2)
			{
				stockPrice = StockMarketManager_1850.StockPrefabListIndustri[cityManager.activeCity].GetComponent<stock>().StockPrice[StockMarketManager_1850.StockPrefabListIndustri[0].GetComponent<stock>().StockPrice.Count - 1];
			}
