...
public class GAV : MonoBehaviour
{
	...
	{
		if (sectorName == "Mines")
		companyGAVText.text = "GAV: " + Mathf.Round(PortfolioStock.minesCompanyGAV[cityManager.activeCity]*100)/100;

		if (sectorName == "Railroad")
			companyGAVText.text = "GAV: " + Mathf.Round(PortfolioStock.railroadCompanyGAV[cityManager.activeCity] * 100) / 100;

		if (sectorName == "Industri")
			companyGAVText.text = "GAV: " + Mathf.Round(PortfolioStock.industriCompanyGAV[cityManager.activeCity] * 100) / 100;
	}
